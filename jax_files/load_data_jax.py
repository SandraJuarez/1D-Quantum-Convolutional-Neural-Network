...
def data(dataset):
    ...
    if dataset=='sp500_md':
        ...
        scaled_data_sp500 = (data - data.min(axis=1,keepdims=True)) / (data.max(axis=1,keepdims=True) - data.min(axis=1,keepdims=True))
        ...
        # Añadir una dimensión extra para trabajar con batches
        ...
        for t in range(18,1018):
            ...
            #print(scaled_data_mackey_glass[t-18])
            #print(scaled_data_mackey_glass[t-18].shape)
