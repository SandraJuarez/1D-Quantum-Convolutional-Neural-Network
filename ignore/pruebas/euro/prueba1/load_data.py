...
def data(dataset):
    ...
    if dataset=='euro':
        ...
        data_mackey_glass = mackey_glass(sample_len=1024,seed=0)[0]
        scaled_data_mackey_glass = scaler.fit_transform(data_mackey_glass)
        ...
        scaled_data_test = scaled_data[500:,0:5]
    ...
    return X_train,Y_train,X_train,Y_test,trainloader,testloader