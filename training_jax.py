...
def train_testing_phase(X_train,Y_train,X_test,Y_test,kernel_size,n_layers,ansatz,out_size,out_channels,trainloader,testloader,run_Name,dataset,original_dataset,architecture,key):
    ...
    with mlflow.start_run(run_name=run_Name):
        ...
        epochs = 30 #for time complexity measurments set to 5
        Loss_hist=[]
        #for the rescaling
        ...
        #resta_l, forecasted=get_resta(X_train,Y_train,min_dataset,max_dataset)
        ...
        for data in trainloader:
            ...
            targ.append(targets)
            forecasted.append(p)
        #print('el forecasted',forecasted)
